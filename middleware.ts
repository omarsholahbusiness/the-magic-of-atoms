...
export const config = {
  matcher: [
    "/((?!api|_next/static|_next/image|favicon.ico|teacher-image.png|logo.png|male.png|relativity.png|graduation-hat.png|notebook.png|eng.png|australia.png|new-zealand.png|europe.png|asia.png|africa.png|south-america.png|north-america.png|oceania.png|antarctica.png|atom.png|sodium.png|music.png|tiktok.png|facebook.png|instagram.png|twitter.png|youtube.png|linkedin.png|).*)",
  ],
};