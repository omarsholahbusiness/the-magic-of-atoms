        ...
        >
          <div className="inline-block bg-brand/10 border-2 border-brand/20 rounded-lg px-6 py-3 mb-4">
            <p className="font-semibold text-lg text-brand">
              {" "}
              الدعم الفني : 01010111332
            </p>
          </div>

          <div className="flex items-center justify-center gap-4 mb-4">
            <a
              href="https://youtube.com/@eidnoshy?si=H5w0BZBXKN6-SHgh"
              target="_blank"
            ...
            <a
              href="https://www.facebook.com/profile.php?id=100068287748296"
              target="_blank"
              rel="noopener noreferrer"
