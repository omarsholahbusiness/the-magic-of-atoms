...
export default function BalancePage() {
  ...
  const cashNumbers = ["01010111332", "01156493943"];
  const whatsappNumber = "01010111332";
  const whatsappLink = `https://wa.me/201010111332`;
        ...
        <Card className="border-brand/20 bg-brand/5">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              إضافة رصيد عبر فودافون كاش او اتصالات كاش
            </CardTitle>
            <CardDescription>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-card rounded-lg p-4 border-2 border-brand/30">
              <p className="text-sm text-muted-foreground mb-2">ارقام الكاش</p>
              <div className="space-y-2">
                {cashNumbers.map((number, index) => (
                  <div key={number} className="flex items-center justify-between">
                    <p className="text-2xl font-bold text-brand">{number}</p>
                    <Button
                      variant="outline"
                      size="icon"
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-2">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
                <li>قم بتحويل المبلغ المطلوب إلى احد الرقمين</li>
